  ...
  return (
    <div className="flex flex-col h-screen w-screen items-center justify-center bg-[url(public/assets/login2.png)]">
      ...
      <div className="flex flex-col text-white bg-fundo-medio p-20 pr-30 pl-30 gap-3 rounded-4xl border-sec border-2">
        ...
        <input
          className="text-black bg-white w-lg rounded-md p-2 border-3 border-solid border-gray-300 focus:border-red-500 focus:outline-none"
          type="text"
        ...
        <br></br>
        <div className="flex items-center justify-center">
          <button className="bg-accent w-50 h-10 rounded-md shadow-[0px_6px_0px_0px_#740510] cursor-pointer hover:scale-105 transition-transform">
            {" "}
            Entrar{" "}
          </button>
        </div>
